...
`Python` `Pandas` `NumPy` `Data Mining`

**[SAVI — Emergency Chatbot](https://github.com/Himanshu6231/savi-emergency-chatbot)**
A rule-based AI chatbot built to guide users through urgent queries in high-stress situations, with a companion Kotlin app UI.
`Python` `NLP` `Rule-Based AI` `Kotlin`

**[Fuel Efficiency Prediction System (MPG Prediction)](https://github.com/Himanshu6231/fuel-efficiency-prediction)**
Regression pipeline trained on 200,000 vehicle records (15 features) to predict MPG, tuned with an XGBoost Regressor + GridSearchCV (R² ≈ 0.87, MAE ≈ 7 MPG), deployed via Streamlit.
